...
function loadCloud(){installSafariStorageFix();const s=document.createElement('script');s.src='cloud-sync.js?v=5';s.onload=()=>{setTimeout(addMobileButton,50);loadSecurity();loadAutoHook()};document.body.appendChild(s)}
